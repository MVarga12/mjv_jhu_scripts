      ...
      for i in range(2,10000,1):
            try:
                  if not os.path.exists('op_'+str(j)+'/op_'+str(j)+'_'+str(i)+'.dat'):
                        x = [line.strip() for line in open('../window_'+str(j)+'_tot/disha_'+str(j)+'_'+str(i)+'.dat','r')]
                        y = [line.strip() for line in open('../window_'+str(j)+'_tot/dishd_'+str(j)+'_'+str(i)+'.dat','r')]
